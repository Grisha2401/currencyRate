...
public class Main {
    public static void main(String[] args) {
        ...
        ExchangeRateProvider exchangeRateProvider = new JsonFileExchangeRateProvider("/Users/alfa/IdeaProjects/currencyRate/src/main/resources/exchange_rates.json");
